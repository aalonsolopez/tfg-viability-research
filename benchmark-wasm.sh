# Variables
ITERATIONS=$1
OUTPUT_FILE="benchmark_output-wasm-aot.txt"
...
IMAGE_NAME="hello-world/wasm-aot:latest"
...
for i in $(seq 1 $ITERATIONS); do
    ...
    CONTAINER_NAME="benchmark-wasm-container-$i"

    docker run --runtime=io.containerd.wasmedge.v1 --name $CONTAINER_NAME $IMAGE_NAME | grep "Execution" >> $OUTPUT_FILE
